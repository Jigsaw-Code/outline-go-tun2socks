...
// NewOutlinePacketListener creates an outline Shadowsocks PacketListener from the JSON config.
func NewOutlinePacketListener(configJSON string) (transport.PacketListener, error) {
